...
{
    public partial class AddEmployeeAndCountryTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Countries",
                columns: new[] { "Id", "CreatedId", "Name", "SoftDelete" },
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(
                table: "Employees",
                columns: new[] { "Id", "Address", "Age", "CreatedId", "FullName", "SoftDelete" },
                values: new object[,]
                {
